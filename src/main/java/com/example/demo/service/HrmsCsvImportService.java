...
import com.example.demo.model.HrmsCsvImportRequest;
import com.example.demo.model.HrmsCsvImportResponse;
import com.example.demo.model.HrmsResetResponse;
...
public class HrmsCsvImportService {
    ...
    public HrmsCsvImportResponse importCsvFiles(MultipartFile employeesCsv, MultipartFile salaryStructureCsv, 
        ...
        if (accessToken == null || sid == null) {
            throw new IllegalStateException("Sid="+ sid +" access= "+accessToken);
        }
